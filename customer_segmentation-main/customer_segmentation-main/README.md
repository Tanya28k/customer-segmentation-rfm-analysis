# Customer Segmentation & Customer Analytics using RFM Analysis
...
This project focuses on customer segmentation using RFM (Recency, Frequency, Monetary) Analysis. The objective is to identify valuable customer groups, analyze purchasing behavior, and provide actionable business insights through data visualization and dashboard reporting.

The project combines Python-based data analysis with Power BI dashboards to support customer retention and marketing strategies.
...
This project was developed using Jupyter Notebook, Python, and Power BI Desktop for customer analytics and visualization.
...
The front-end of this project consists in a **Power BI dashboard** that processes the CSV resulting from executing the previous Python code, and visualizes the results in a pleasing dashboard.isidro/customer_segmentation/blob/main/output/customer_segmentation.pbix) for exploring it.
...
The Power BI dashboard enables business users to analyze customer segments, identify high-value customers, and monitor at-risk customers. Interactive filters allow users to explore customer behavior across different countries and customer segments.
